    ...
    <div class="w-100">
        ...
        <div class="collapse navbar-collapse scrollbar py-lg-2" id="navbarDoubleTop">
            <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                <li class="nav-item dropdown active"><a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dashboards">Dashboard</a>
            ...
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                    ...
                    ?>
                        ...
                        <a class="nav-link" href="service.php" role="button">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="bx bx-list-ul"></span></span><span class="nav-link-text ps-1">Services</span></div>
                        </a>
                    ...
                    ?>
                        ...
                        <a class="nav-link" href="client.php" role="button">
                            <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="bx bx-list-ul"></span></span><span class="nav-link-text ps-1">Client</span></div>
                        </a>
                ...
                <li class="nav-item">
                    ...
                    if ($analytics) {
                    ?>
                        <a class="nav-link" href="widgets.php" role="button">
