...
<div class="preloader">
    ...
    <div class="vertical-centered-box">
        <div class="content">
            ...
            <img src="assets/Logos/SVGs/favicon.svg" width="90" alt>
        </div>
    </div>
</div>
...
<div class="header-sidebar">
    <div class="siderbar-top">
        <div class="sidebar-log">
            <a href="index-2.php"><img src="assets/Logos/SVGs/logo.svg" alt></a>
        </div>
        <div class="close-btn">
        ...
        <div class="content">
            <div class="informations">
                ...
                <div class="single-info">
                    ...
                    <div class="info">
                        <a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#7e5e171018113e1b061f130e121b501d1113"><span class="__cf_email__" data-cfemail="10797e767f507568717d607c753e737f7d">[email&#160;protected]</span></a>
                        <a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#dfffb6b1b9b09facaaafafb0adabf1bcb0b2"><span class="__cf_email__" data-cfemail="e78e898188a794929797889593c984888a">[email&#160;protected]</span></a>
                    </div>
                </div>
            </div>
        </div>
...
<header class="header-area2 one">
    <div class="header-logo">
        <a href="index-2.php"><img alt="image" class="img-fluid" src="assets/img/logo.png" style="width: 130px;"></a>
    </div>
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <a href="index-2.php"><img alt="image" src="assets/img/logo.png"></a>
            </div>
        </div>
        <ul class="menu-list">
            ...
            <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                    <li><a href="service.php">Service 01</a></li>
                    <li><a href="service2.php">Service 02</a></li>
                    <li><a href="service3.php">Service 03</a></li>
                    <li><a href="service4.php">Service 04</a></li>
            ...
            <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="project-masonary.php">Project Masonry</a></li>
                ...
                <ul class="sub-menu">
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="team3.php">Team 03</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="pricing.php">Pricing 01</a></li>
                            <li><a href="pricing2.php">Pricing 02</a></li>
                        </ul>
                    </li>
            ...
            <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                    <li><a href="case-study.php">Case study 01</a></li>
                    <li><a href="case-study2.php">Case study 02</a></li>
                    <li><a href="case-study-standard.php">Case study standard</a></li>
            ...
            <li class="menu-item-has-children">
                ...
                ?>
                    <a href="#" class="drop-down"><?php echo $username; ?></a><i class="bi bi-plus dropdown-icon"></i>
                    <ul class="sub-menu">
                        <li><a href="profile.php">Profile</a></li>
                        <li><a href="orders.php">My Orders</a></li>
                        <li><a href="logout.php">Logout</a></li>
                    </ul>
                <?php else: // Agar user login nahi hai 
                ?>
                    <a href="#" class="drop-down">Account</a><i class="bi bi-plus dropdown-icon"></i>
                    <ul class="sub-menu">
            ...
            <form class="mobile-menu-form">
                ...
                <div class="email pt-20 d-flex align-items-center">
                    ...
                    <div class="email-info">
                        <span>Email Now</span>
                        <h6><a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#d7b2afb6baa7bbb297b0bab6bebbf9b4b8ba"><span class="__cf_email__" data-cfemail="016479606c716d6441666c60686d2f626e6c">[email&#160;protected]</span></a></h6>
                    </div>
                </div>
            </form>
