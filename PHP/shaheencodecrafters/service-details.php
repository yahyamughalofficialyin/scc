...
<!-- Mirrored from demo-egenslab.b-cdn.net/html/softconic/preview/service-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Oct 2024 19:40:51 GMT -->
...
<body class="home-dark2 tt-magic-cursor">
                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper">
                        <div class="breadcrumb-cnt">
                            ...
                            <h1 id="service-name" >"Software
                                Development"</h1>
                            <div class="breadcrumb-list">
                                <a href="index-2.html">Home</a><img src="assets/img/inner-pages/breadcrumb-arrow.svg" alt> Services Details
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 d-flex align-items-center wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about-content">
                            <div class="section-title-5">
                                <h2 id="service-name" >Software <br> Development</h2>
                            </div>
                            <p id="service-description" >Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh
    ...
    <script>
        $(document).ready(function () {
            // Get the service ID from the URL (e.g., service-details.php?id=1)
