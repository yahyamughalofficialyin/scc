  ...
  return (
    <div>
              ...
              <div class="banner-wrapper">
                <div class="banner-content">
                  ...
                  <div class="banner-btn-group">
                    <a class="primary-btn3" href="contact.html">
                      Free Consultancy
                    </a>
                ...
                <div class="banner-video-area">
                  <div class="video-area">
                    <a
                      ...
                      class="video-popup"
                      href="https://www.youtube.com/watch?v=u31qwQUeGuM&amp;ab_channel=JoomlaTemplate"
                    >
                      <svg
                        width="30"
                        height="34"
      ...
      <div class="home3-solution-section sec-mar">
        <div class="container">
          <div
            class="row mb-55 wow animate fadeInUp"
                    ...
                    <div class="solution-card">
                      ...
                      <div class="solution-content">
                        ...
                        <p>
                          ...
                          and web applications for the internet or intranet.
                        </p>
                    ...
                    <div class="solution-card">
                      ...
                      <div class="solution-content">
                        ...
                        <p>
                          ...
                          interpreting large datasets to extract insights and
                          draw conclusions.
                        </p>
                        <ul class="solution-feature">
                          <li>
      ...
      <div class="home3-about-section">
        <div class="container-fluid">
          <div class="row g-lg-4 gy-5">
            <div class="col-lg-9">
              <div
                class="section-title-3 wow animate fadeInUp"
                data-wow-delay="200ms"
                data-wow-duration="1500ms"
              >
                <h2>Our Approach</h2>
              ...
              <div class="about-left">
                <div
                  class="about-img  wow animate fadeInUp"
                ...
                <div
                  class="about-content wow animate fadeInUp"
                  data-wow-delay="400ms"
                  data-wow-duration="1500ms"
                >
                  <h2>Unlock the potential of your business.</h2>
                  <p>
                    We believe in delivering tailored solutions that are
                    designed to address your unique requirements. We take the
                    time to understand your business and provide personalized
            ...
            <div class="col-lg-3">
              <div class="about-right">
                ...
                <div
                  class="about-exprience d-flex align-items-center justify-content-center wow animate fadeInUp"
                  data-wow-delay="300ms"
                  data-wow-duration="1500ms"
                >
                  <div class="exp-text">
          ...
          >
            <div class="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-4">
              ...
              <div class="view-all-btn">
                <a class="primary-btn3" href="project.html">
                  View All Project
                </a>
              </div>
            </div>
                  ...
                  <div class="swiper-slide">
                    <div class="success-storie-card">
                      ...
                      <div class="success-content">
                        ...
                        <h3>
                          <a href="project-details.html">
                            Maximizing Efficiency with DevOps
                          </a>
                        </h3>
                        <div class="view-btn">
                          <a href="project-details.html">
                    ...
                    <div class="testimonial-card3">
                      ...
                      <div class="testimonial-content">
                        <p>
                          ...
                          ullamcorper nec dolor. and utoor himenaeos. Praesent
                          nec neque at dolor venenatis consectetur european gon
              ...
              <div class="tab-content" id="nav-tabContent">
                ...
                >
                  <div class="row g-lg-0 g-4 align-items-center justify-content-center">
                    <div
                      class="col-xl-4 col-md-6 wow animate fadeInLeft"
                      data-wow-delay="300ms"
                      data-wow-duration="1500ms"
                    >
                    ...
                    <div
                      class="col-xl-4 col-md-6 wow animate fadeInUp"
                      data-wow-delay="200ms"
                      data-wow-duration="1500ms"
                    >
                    ...
                    <div
                      class="col-xl-4 col-md-6 wow animate fadeInRight"
                      data-wow-delay="400ms"
                      data-wow-duration="1500ms"
                    >
                      <div class="pricing-card">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="contact-wrapper text-center">
                ...
                <div
                  class="contact-btn magnetic-item  wow animate fadeInUp"
                  data-wow-delay="200ms"
                  data-wow-duration="1500ms"
                >
                  <a href="contact.html">
      ...
      <div class="home3-team-area sec-mar">
        <div class="container">
          ...
          <div class="row">
            <div
              class="col-lg-3 col-sm-6 experts wow animate fadeInUp"
              data-wow-delay="200ms"
              data-wow-duration="1500ms"
            >
      ...
      <div class="home3-blog-area sec-mar">
        <div class="container">
          ...
          <div class="row justify-content-center g-lg-4 gy-5">
            <div
              class="col-lg-4 col-md-6 wow animate fadeInLeft"
              data-wow-delay="300ms"
              data-wow-duration="1500ms"
            >
              <div class="single-blog magnetic-item">
                ...
                <div class="blog-content">
                  <ul class="blog-meta">
                    <li>
                      <a href="blog.html">May 20, 2023</a>
                    </li>
                    <li>
                      <a href="blog.html">Comment (3)</a>
                    </li>
                  </ul>
                  <h4>
            ...
            <div
              class="col-lg-4 col-md-6 wow animate fadeInUp"
              data-wow-delay="200ms"
              data-wow-duration="1500ms"
            >
              <div class="single-blog magnetic-item">
            ...
            <div
              class="col-lg-4 col-md-6 wow animate fadeInRight"
              data-wow-delay="300ms"
              data-wow-duration="1500ms"
            >
              <div class="single-blog magnetic-item">
                ...
                <div class="blog-content">
                  ...
                  <h4>
                    <a href="blog-details.html">
                      Navigating the Journey off Cloud Solution.
                    </a>
                  </h4>
                  <div class="blog-footer">
                    <div class="read-btn">
